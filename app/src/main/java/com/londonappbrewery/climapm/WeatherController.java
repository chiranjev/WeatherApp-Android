...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "17fd4a1e3c90326ba55212b0e5e148c0";
    ...
    protected void onResume() {
        ...
        if(city!=null)
        {
            Log.d("Clina","Getting weather for city entered");
    ...
    private void getWeatherForCurrentLocation() {
        mLocationManager = (LocationManager) getSystemService(Context.LOCATION_SERVICE); // get instance of location manager
